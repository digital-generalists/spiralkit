//
//  DGSKStrokeDrawDataProviderProtocol.h
...
@protocol DGSKStrokeDataProviderProtocol;

@protocol DGSKStrokeDrawDataProviderProtocol <DGSKDrawDataProviderProtocol>

@property (nonatomic, readonly) NSArray *drawStrokes;
