...
lipo -create -output "${OUTPUT_PACKAGE_DIR}/${PRODUCT_NAME}.framework/${PRODUCT_NAME}" "${BUILD_DIR}/${OUTPUT_CONFIGURATION_NAME}-iphoneos/${PRODUCT_NAME}.framework/${PRODUCT_NAME}"
