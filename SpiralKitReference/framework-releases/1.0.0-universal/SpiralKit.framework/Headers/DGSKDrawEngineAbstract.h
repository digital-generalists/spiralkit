...
@interface DGSKDrawEngineAbstract : NSObject<DGSKUnloadableInstanceProtocol>
...
@property (readonly, strong) UIView<DGSKDrawViewProtocol> *hostView;

@property (readonly, strong) id<DGSKDrawContextStylingProviderProtocol> stylingProvider;

@property (readonly, strong) id drawData;

@property (nonatomic) int processedTouchesForActiveStroke;
