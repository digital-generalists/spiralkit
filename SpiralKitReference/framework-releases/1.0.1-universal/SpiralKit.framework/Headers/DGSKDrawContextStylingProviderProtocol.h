//
//  DGSKDrawContextStylingProviderProtocol.h
...
@protocol DGSKDrawContextStylingProviderProtocol <NSObject, NSCoding>

@property (nonatomic) DGSKDrawToolType drawToolType;

@property (nonatomic, readonly) CGColorSpaceRef (*CreateStylingColorSpace)(void);
